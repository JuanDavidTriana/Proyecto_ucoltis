      ...
      <Router>
        ...
        <div className="container mt-4">
          <Switch>
            ...
            <Route path="/shop" component={ProductListPage} exact />
            ...
            <Route path="/card-details" component={CardDetailsPage} exact />
            <Route path="/card-update" component={CardUpdatePage} exact />
